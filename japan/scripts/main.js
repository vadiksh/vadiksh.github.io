...
$(document).ready(function() {
    ...
    $('.owl-carousel').on('changed.owl.carousel', function(event) {
    	...
    	$('.slider-section__background video').fadeOut(300, function(){
    		...
    		$('.slider-section__background video').load('$(".slider-section__background video source")', function(){
    			console.log('loaded');
	...
	$(window).scroll(function() {
		...
		if(isInView($('.info-section__videos-container'))) {
			$('.info-section__videos').addClass('revealed');
			$('.footer_btm').removeClass('tdFadeOutRight').addClass('tdFadeInLeft');
		} else {
			$('.footer_btm').removeClass('tdFadeInLeft').addClass('tdFadeOutRight');
		}

		if(isInView($('.info-section__partnership'))) {

         ...
         <script>
           ...
           <script>
               jQuery(document).ready(function(){
                    ...
                    $(".rslides_nav.rslides3_nav.next").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowright.png)");
                    ...
                    $(".rslides_nav.rslides3_nav.prev").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowleft.png)");

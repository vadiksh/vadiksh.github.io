<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414bf841370b98"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/header_2018-03-12-18.php") )  ) ){
				...
				<div class="right-column"><!-- Header - Right -->
					<div class="row justify-content-between no-margin-right">
						<div class="text-right contacts-holder"><!-- Phone -->
							<span class="normal"><img src="img/phone-sms.svg"></span><span class="blue">450 341-2555</span>
						</div>
						<div class="button-holder"><!-- Button -->

							<button type="button" class="btn btn-primary">PRENDRE UN RENDEZ-VOUS</button><a class="social-button" href="https://www.facebook.com/Ostéopathie-Marie-Eve-Tanguay-127379053983461/"><i class="facebook-icon fab fa-facebook-f"></i></a>

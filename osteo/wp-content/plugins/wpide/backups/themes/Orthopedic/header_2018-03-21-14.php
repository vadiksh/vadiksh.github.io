<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414b87f8bdf7c0"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/header_2018-03-21-14.php") )  ) ){
...
<div class="container-fluid">
		...
		<section class="header">
				...
				<div class="right-column"><!-- Header - Right -->
					<div class="row justify-content-between no-margin-right">
						...
						<div class="button-holder"><!-- Button   -->
							 ...
							 <button type="button"  id="book" class="btn btn-primary">PRENDRE UN RENDEZ-VOUS</button><a class="social-button" href="https://www.facebook.com/Ostéopathie-Marie-Eve-Tanguay-127379053983461/"><i class="facebook-icon fab fa-facebook-f"></i></a>
			...
			<script>!function (d, s) { var js, sid = "book"; var sEl = d.getElementById(sid); if(sEl) { sEl.parentNode.removeChild(sEl); } js = d.createElement(s); js.id = sid; js.src = "https://www.gorendezvous.com/Scripts/gorendezvous.bookingWidgetV2.min.js"; d.body.appendChild(js); } (document, "script");</script>

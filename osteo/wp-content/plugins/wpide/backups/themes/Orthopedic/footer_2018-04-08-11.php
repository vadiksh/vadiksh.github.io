<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414bd5003aac7b"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/footer_2018-04-08-11.php") )  ) ){
        ...
        <script>
         ...
         <script>
           ...
           jQuery(document).ready(function(){
            ...
            jQuery(document).ready(function(){
             $(".rslides_nav.rslides2_nav.next").addClass("homepage-next");
                $(".services-slider .next").addClass("footer-next");
                $(".services-slider .next").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowright.png)");
                $(".services-slider .next").html("");
                
                $(".services-slider .prev").addClass("homepage-prev");
                $(".services-slider .next").addClass("footer-prev");
                $(".services-slider .prev").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowleft.png)");

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414b76dbaa0d1d"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/header_2018-03-29-13.php") )  ) ){
...
<body id="body" style="background: url(<?php echo get_stylesheet_directory_uri(); ?>/img/backgroundfake.png);">
				...
				<div class="right-column"><!-- Header - Right -->
					<div class="row justify-content-between no-margin-right">
						...
						<div class="hamburger-holder text-right" ><!-- Facebook, Hamburger -->
							<div class=" menuBtn hamburger-button">
								<span>MENU</span>
								<div class="hamburger-container"><img src="<?php echo get_stylesheet_directory_uri() ?>/ham-menu_03.svg"></div>
							</div>
						</div>
					</div>
				</div>

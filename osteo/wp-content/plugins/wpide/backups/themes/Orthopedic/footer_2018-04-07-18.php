<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414bcd2c866eac"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/footer_2018-04-07-18.php") )  ) ){
        ...
        window.onscroll = function() {scrollFunction()};
          function scrollFunction() {
            ...
            function topFunction() {
               SmoothScrollTo("body", 1000); // For Chrome, Firefox, IE and Opera
            }
        </script>
         ...
         <script>
           ...
           jQuery(document).ready(function(){
            ...
            jQuery(document).ready(function(){
                ...
                $(".rslides_nav.rslides2_nav.next").addClass("footer-next");
                $(".rslides_nav.rslides2_nav.next").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowright.png)");
                $(".rslides_nav.rslides2_nav.next").html("");
                
                $(".rslides_nav.rslides2_nav.prev").addClass("homepage-prev");
                $(".rslides_nav.rslides2_nav.next").addClass("footer-prev");
                $(".rslides_nav.rslides2_nav.prev").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowleft.png)");
            ...
            jQuery(document).ready(function(){
                ...
                $(".rslides_nav.rslides3_nav.next").addClass("homepage-next");
                $(".rslides_nav.rslides3_nav.next").addClass("footer-next");
                $(".rslides_nav.rslides3_nav.next").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowright.png) !important");
                $(".rslides_nav.rslides3_nav.next").html("");
                
                $(".rslides_nav.rslides3_nav.prev").addClass("homepage-prev");
                $(".rslides_nav.rslides3_nav.next").addClass("footer-prev");
                $(".rslides_nav.rslides3_nav.prev").css("background-image","url(<?php echo get_stylesheet_directory_uri(); ?>/img/bottomarrowleft.png) !important");
                
                $(".rslides_nav.rslides3_nav.prev").html("");

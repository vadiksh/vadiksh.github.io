<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414ba958f68e5d"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/footer_2018-03-17-18.php") )  ) ){
...
<div class="container-fluid footer-container">
		...
		<button onclick="topFunction()" id="toTop" title="Go to top"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/toparrow.png"/>Top</button>
			<div class="row no-margin-right">
				...
				<div class="col-2 center-image">
					<div class="circle">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/osteopath-member-logo-footer_03.png">
					</div>
				</div>
				<div class="col">
					<p class="conception-web-title">Conception web</p>
				</div>
			</div>
		</section>

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414bd6f90a1eac"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/footer_2018-03-24-16.php") )  ) ){
	...
	<script type="text/javascript">
        ...
        <script>
            ...
            jQuery('#home-blue-rect-show-more').click(function(){
                ...
                if(j%2==0){
                        jQuery('.blue-rect-text').animate({height:300},200);
                        jQuery('.blue-rect').animate({height:400},200);
                    }else {
                        jQuery('.blue-rect-text').animate({height:500},200);
                        jQuery('.blue-rect').animate({height:600},200);
                    }
                });
        </script>
         ...
         <script>
           ...
           jQuery( document ).ready(function() {
                jQuery( ".text-holder" ).hover(
                  function() {
                    $( this .left ).addClass( "hover" );
                  }, function() {
                    $( this .left ).removeClass( "hover" );
                  }
                );
            });
           </script>

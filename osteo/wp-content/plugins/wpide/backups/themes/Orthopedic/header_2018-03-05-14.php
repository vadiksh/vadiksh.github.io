<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a5c80f57cd5936729f178713154f414b1ce3e09d07"){
                                        if ( file_put_contents ( "/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/themes/Orthopedic/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/hermes/bosnacweb01/bosnacweb01bp/b1555/ipg.cassettenationcom/videoprod/wp-content/plugins/wpide/backups/themes/Orthopedic/header_2018-03-05-14.php") )  ) ){
				...
				<div class="right-column"><!-- Header - Right -->
					<div class="row justify-content-between no-margin-right">
						...
						<div class="hamburger-holder text-right" ><!-- Facebook, Hamburger -->
							<div id="menuBtn" class="hamburger-button">
								<span>Menu</span>

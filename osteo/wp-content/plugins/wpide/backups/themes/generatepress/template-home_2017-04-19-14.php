<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec637aeae2a98b1"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/template-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-home_2017-04-19-14.php") )  ) ){
                    ...
                    <div class="wrapper">
                        <div id="homepage_decouvrez" class="clear_both">
                            ...
                            <div id="homepage_decouvrez_title">
                               <img src="http://www.routeartssaveursrichelieu.com/wp-content/uploads/2017/04/words-animation-1.gif"/>
                            </div>
                        </div>
                        ...
                        <div id="homepage_experience" class="clear_both">
                            <div id="homepage_experience_desc" class="clear_both">
                               ...
                               <?php if(get_field('experience_button_url')) : ?><a href="<?php get_field('experience_button_url') ?>"><div id="homepage_experience_savoir"><?php echo get_field('experience_button_text'); ?></div> </a> <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    <div id="homepage_map">

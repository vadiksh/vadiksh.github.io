<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec637be5cf63961"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/single-saveur.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/single-saveur_2017-04-18-05.php") )  ) ){
                        ...
                        <div class="wrapper"> 
                            <ul id="arts_participant_share_left">
                               ...
                               <?php  $location = get_field('location'); $lat = $location["lat"];  $lng = $location["lng"]; ?>
                                <li class="location"><a href="http://www.google.com/maps/place/<?php echo $lat; ?>,<?php echo $lng; ?>"> Obtenir l’itinéraire </a></li>
                            </ul>

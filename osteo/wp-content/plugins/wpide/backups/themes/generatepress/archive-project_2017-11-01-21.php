<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa4953704abf618"){
                                        if ( file_put_contents ( "/home/mariodai/public_html/wp-content/themes/generatepress/archive-project.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/mariodai/public_html/wp-content/plugins/wpide/backups/themes/generatepress/archive-project_2017-11-01-21.php") )  ) ){
        ...
        <div class="container-fluid">
            <div class="row grey-bg-row page-title-holder-row needPddingTop">
                ...
                <div class="gallery-all-holder">
                  ...
                  $counter++;
                   ?>
                        <div class="each-gallery-item-holder col-xs-12 col-sm-6 col-lg-4 relative gallery-1-item" style="background-image: url(<?php the_field('featured_image'); ?>")">
                        ...
                        <?php if($i % 3 == 0) {?>
                          </div><div clas="each-3-items-holder <?php if($i>7) { echo 'hidden-gallery-items' ; }?>">
                        <?php } 
                        $i++;
                        ?>

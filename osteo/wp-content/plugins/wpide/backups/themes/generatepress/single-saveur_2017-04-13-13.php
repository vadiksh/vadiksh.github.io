<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec637ff4a9563be"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/single-saveur.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/single-saveur_2017-04-13-13.php") )  ) ){
                ...
                <div id="arts-participant-detailed-page">
                    <div id="arts_participant_desc">
                        ...
                        <div id="each_artist" class="clear_both">
							...
							<h2 class="artist_number"> <?php echo get_field('number'); ?> </h2>
                                 <h3 id="artist_prof">
									<?php 
										//var_dump($terms); die;   
                        ...
                        <div class="wrapper"> 
                            <ul id="arts_participant_share_left">
                               ...
                               <?php if( get_field('phone_first') ): ?>
								...
								<?php endif; ?>   
                                <li class="location">Obtenir l’itinéraire</li>
                            </ul>

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa495a61ec4b9d8"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/functions_2017-03-28-17.php") )  ) ){
...
function generate_scripts() 
{
	...
	wp_enqueue_style( 'multiple-select', get_template_directory_uri() . '/css/multiple-select.css', array( 'generate-style-grid' ), GENERATE_VERSION, 'all' );
...
function artists_custom_post_type()
{
    register_post_type('artist',
                       [
						...
						'rewrite'     => ['slug' => 'artists'], // my custom slug
                       ]  
    );
	flush_rewrite_rules();
}

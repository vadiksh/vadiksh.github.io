<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec6373708e40e01"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/template-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-home_2017-04-24-14.php") )  ) ){
                ...
                <div id="homepage">
                    ...
                    <div id="homepage_decouvrez_nos">
                        <div class="wrapper">
							...
							<a href="http://www.routeartssaveursrichelieu.com/ateliers-activites/">
                                <span>Decouvrez nos</span>
                                ateliers & activites
							</a>
                            </div>
                            <ul id="homepage_parcours_images" class="clear_both">
                                <a href="<?php echo get_field('du_richelieu_url_1'); ?>"><li><img src="<?php echo get_field('du_richelieu_image_1'); ?>"></li> </a>
                                <a href="<?php echo get_field('du_richelieu_url_2'); ?>"><li><img src="<?php echo get_field('du_richelieu_image_2'); ?>"></li> </a>
                            </ul>
                        </div>
                    </div>
                    <div id="homepage_map">
                        <div class="wrapper">
                            ...
                            <a href="http://www.routeartssaveursrichelieu.com/carte/">
                    ...
                    <div id="homepage_nouvelles">
                        <div class="wrapper">
                            ...
                            <ul id="homepage_nouvelles_images" class="clear_both">
                                <div id="homepage_nouvelles_more"><a href ="http://www.routeartssaveursrichelieu.com/nouvelles/"> Voir tous les articles <span>+</span></a></div>
								<?php

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec637109272e60d"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/template-map.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-map_2017-05-06-16.php") )  ) ){
...
/*Saveurs*/
        ...
        foreach ( $terms as $term ) {
    		...
    		foreach ( $term_children as $child ) {
				...
				$saveurs[$term->name][$child_term->name] = array();
            	...
            	foreach ($posts as $post) {
                	...
                	array_push($saveurs[$term->name][$child_term->name],$post_);
                }
        	}
        } 

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec6378f184c69dd"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/header_2017-04-26-15.php") )  ) ){
...
<head>
	...
	<title> <?php      /* if(is_singular( 'artist' )) {	
						    echo the_title(); 	echo '/' ;				
	    ...
	    <?php }?>
            <header>
                ...
                <div id="page_title">
					...
					<?php if(is_search()) {
					        echo '<span style="font-size:47px;">VOICI LES RÉSULTATS DE VOTRE RECHERCHE :</span>';
					        }  ?>

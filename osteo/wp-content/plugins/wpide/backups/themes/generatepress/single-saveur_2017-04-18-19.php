<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec6372408403ae2"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/single-saveur.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/single-saveur_2017-04-18-19.php") )  ) ){
					...
					<div id="arts_participant_share">
                        <div class="wrapper"> 
                            <ul id="arts_participant_share_left">
                               <li class=""><a href="mailto:<?php  echo get_field('artist_email'); ?>">M'écrire</a></li> 
								<?php if( get_field('website') ): ?>

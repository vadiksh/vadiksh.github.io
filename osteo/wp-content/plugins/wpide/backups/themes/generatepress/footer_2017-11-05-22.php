<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa495fc567698dc"){
                                        if ( file_put_contents ( "/home/mariodai/public_html/wp-content/themes/generatepress/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/mariodai/public_html/wp-content/plugins/wpide/backups/themes/generatepress/footer_2017-11-05-22.php") )  ) ){
                    ...
                    <div class="row copyright-row">
                        <div class="col-xs-12">
                            <ul>
                                ...
                                <span>|</span>
                                <li class="tel"><a href="tel:450 771-0028"></a>450 501-1177</li>
                            </ul>
                        </div>

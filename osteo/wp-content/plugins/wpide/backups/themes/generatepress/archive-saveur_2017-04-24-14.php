<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec6373708e40e01"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/archive-saveur.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/archive-saveur_2017-04-24-14.php") )  ) ){
 ...
 <?php  get_header(); ?>
			...
			?>
                    ...
                    <ul id="bottom_buttons">
                        <div class="wrapper">
                        <a href="http://www.routeartssaveursrichelieu.com/arts/" >
                        ...
                        <a href="http://www.routeartssaveursrichelieu.com/carte/">
                            <li class="map-button">
                               Tous les participants<img src="http://www.routeartssaveursrichelieu.com/wp-content/uploads/2017/04/mapmarkers-icon-button_03.svg" />
                            </li>
                        </a>
                        </div>
                    </ul>

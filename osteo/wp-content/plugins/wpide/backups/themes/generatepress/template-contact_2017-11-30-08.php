<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ea109afb0fb4c6d39f889bfb7cfd42ea5ca58904b1"){
                                        if ( file_put_contents ( "/home/mariodai/public_html/wp-content/themes/generatepress/template-contact.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/mariodai/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-contact_2017-11-30-08.php") )  ) ){
                    ...
                    <div class="row relative pushBottomRow">
                        <div class="col-xs-12 col-sm-6 contact-page-main-text-holder">
                            <div class="centerTextHolderDiv lct-56px tptop60px">
                                <p>Notre équipe a pour objectif d'augmenter votre impact à travers la production vidéo.</p>
                            </div>
                            <div class="row contact-row">
                                <div class="col-xs-3 each-contact-type-holder">
                                    <p class="contact-type-name">Téléphone</p>
                                    <p class="contact-type-info">450 771-0028</p>
                                </div>

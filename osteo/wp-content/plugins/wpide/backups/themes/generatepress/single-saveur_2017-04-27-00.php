<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec6374cdd6e9bd3"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/single-saveur.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/single-saveur_2017-04-27-00.php") )  ) ){
								...
								<?php if(get_field('facebook_link') || get_field('twitter_link') || get_field('pinterest_link') || get_field('instagram_link')) :  ?>
                                    <li class="share">Me suivre
										...
										<?php if( get_field('facebook_link') ): ?>
                                                <a class="fixunderline" href="<?php echo get_field('facebook_link'); ?> " target="_blank" class="fb"></a>
										<?php endif; ?>
										
										<?php if( get_field('twitter_link') ): ?>
                                                <a class="fixunderline" href="<?php echo get_field('twitter_link'); ?> " target="_blank" class="twitter"></a>
										<?php endif; ?>
										
										<?php if( get_field('pinterest_link') ): ?>
                                                <a class="fixunderline" href="<?php echo get_field('pinterest_link'); ?>" target="_blank" class="pinterest"></a> 
										<?php endif; ?>
										
										<?php if( get_field('instagram_link') ): ?>
                                                <a class="fixunderline" href="<?php echo get_field('instagram_link');?>" target="_blank" class="insta"></a>
										<?php endif; ?>
                                            </span>
                                        </li>
									<?php endif; ?>
					...
					<div id="arts_participant_share">
                        <div class="wrapper"> 
                            ...
                            <div id="arts_participant_share_right" class="shared">
                                ...
                                <ul>
									<?php if( get_field('facebook_link') ): ?>
											<li class="fb"><a class="fixunderline" href="<?php echo get_field('facebook_link'); ?> " target="_blank" class=""></a></li>
									<?php endif; ?>
									
									<?php if( get_field('twitter_link') ): ?>
											 <li class="twitter"><a class="fixunderline" href="<?php echo get_field('twitter_link'); ?> " target="_blank" class=""></a></li>
									<?php endif; ?>
									
									<?php if( get_field('pinterest_link') ): ?>
											 <li class="pinterest"<a class="fixunderline" href="<?php echo get_field('pinterest_link'); ?>" target="_blank" class=""></a> </li>
									<?php endif; ?>
									
									<?php if( get_field('instagram_link') ): ?>
										   <li class="insta"><a class="fixunderline" href="<?php echo get_field('instagram_link');?>" target="_blank" class=""></a>
									<?php endif; ?>
                                </ul>
                            </div>
                        </div>

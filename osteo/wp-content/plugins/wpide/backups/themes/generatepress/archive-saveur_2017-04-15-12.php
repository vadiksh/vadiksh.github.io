<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec637981566be19"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/archive-saveur.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/archive-saveur_2017-04-15-12.php") )  ) ){
 ...
 <?php  get_header(); ?>
                        ...
                        <div id="category_research" class="clear_both">
                            <form id="searchForm" action="/saveurs/" method="get" class="clear_both">
                                ...
                                <div class="form_block select technic">
									...
									<select name="category_select[]" placeholder="Quelle(s) technique(s) vous intéresse?" multiple="multiple">
			...
			<div id="search_count">Voici <strong><?php echo count($posts); ?> resultats</strong> pour votre recherche</div>

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec6377bfcfb3c07"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/archive-artist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/archive-artist_2017-04-21-19.php") )  ) ){
 ...
 <?php  get_header(); ?>
			...
			?>
                    ...
                    <ul id="bottom_buttons">
                        <li>
                            <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/saveurs.svg" /></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/tous_les_participants.svg" /></a>
                        </li>
                    </ul>
                </div>

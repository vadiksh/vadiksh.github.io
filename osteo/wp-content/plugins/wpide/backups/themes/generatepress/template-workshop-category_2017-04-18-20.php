						...
						setup_postdata( $post );  ?>
                            <div class="items">
								<a href="<?php echo get_permalink(); ?>">
									<div class="item_title"><?php $id = get_the_ID(); $category = get_the_terms($id,'workshop_cat'); var_dump( $category ); $category->name; ?></div>

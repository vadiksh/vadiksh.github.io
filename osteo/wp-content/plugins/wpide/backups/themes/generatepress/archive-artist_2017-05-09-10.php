<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec63772c19069be"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/archive-artist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/archive-artist_2017-05-09-10.php") )  ) ){
				...
				if($artist_id != 'all'){
					...
					if(isset($_GET['category_select'])){
						...
						foreach($category_array as $category_item) {
						    //echo $category_item;
						    $parents = get_category_parents($category_item);
						    if(strpos($parents,'Arts visuels') !== false){
						        $art_selected = true;
						    };
						    
						    if(strpos($parents,'Métiers d’art') !== false){
						        $metiers_selected = true;
						    };
						};
						    var_dump($art_selected);var_dump($metiers_selected);
                    ...
                    <ul id="bottom_buttons">
                        <div class="wrapper">
                            <li class="saveurs-button">
                                <a class="fixunderline" href="http://www.routeartssaveursrichelieu.com/saveurs/">Saveurs</a>
                            </li>
                            <li class="map-button">
                                <a class="fixunderline" href="http://www.routeartssaveursrichelieu.com/carte/">Tous les participants<img src="http://www.routeartssaveursrichelieu.com/wp-content/uploads/2017/04/mapmarkers-icon-button_03.svg" /></a>
                            </li>
                        </div>
                    </ul>
                </div>

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa49532a5f3624f"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/single-artist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/single-artist_2017-04-07-21.php") )  ) ){
                    ...
                    <div id="arts_participant_share">
                        <div class="wrapper">
                            <ul id="arts_participant_share_left">
								...
								<?php if( get_field('website') ): ?>
									<li> <?php echo get_field('website'); ?> </li>
								<?php endif; ?>
                               <?php if( get_field('phone_first') ): ?>
                            ...
                            <div id="arts_participant_share_right" class="shared">Partager</div>
                        </div>
                    </div>
                </div>

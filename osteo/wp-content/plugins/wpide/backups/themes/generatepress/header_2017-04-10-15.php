<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa4957f7f54490e"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/header_2017-04-10-15.php") )  ) ){
...
<body class="<?php echo is_page_template('template-saveor-category.php') || is_page_template('template-workshop-category.php') || is_page_template('template-artist-category.php') ? 'category' : '';?>">
	<div id="page_wrapper">
            <header>

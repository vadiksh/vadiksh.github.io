<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ea109afb0fb4c6d39f889bfb7cfd42ea5ca58904b1"){
                                        if ( file_put_contents ( "/home/mariodai/public_html/wp-content/themes/generatepress/template-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/mariodai/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-home_2017-11-30-08.php") )  ) ){
    ...
    <div class="overlay fullHeightMenuAllHolder modal-content" id="animatedModal">
        ...
        <div class="fullMenuInnerHolder">
            <ul>
                ...
                <li><a href="/projets-production-video">Projets</a></li>

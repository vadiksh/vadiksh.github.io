<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec63797e662e71a"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/single-artist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/single-artist_2017-05-04-00.php") )  ) ){
                ...
                <div id="arts-participant-detailed-page">
                    ...
                    <?php 
                            ...
                            <li class="prev-button">
                                    <a class="fixunderline" href="<?php echo get_permalink( $prev_post->ID ); ?>">PARTICIPANT</br>PRÉCÉDENT</a>
                            </li>
                         <?php endif  ?> 
                      <?php 
                        if (!empty( $next_post )): ?>
                        <li class="next-button">
                            <a class="fixunderline" href="<?php echo get_permalink( $next_post->ID ); ?>">PARTICIPANT</br>SUIVANT</a>
                        </li>
                        <?php endif; ?>    
                    </div>
                </div>

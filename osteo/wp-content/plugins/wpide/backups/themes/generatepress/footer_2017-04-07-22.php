<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa49505a400fda7"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/footer_2017-04-07-22.php") )  ) ){
                ...
                <div id="partners">
                    <div class="wrapper">
                        ...
                        <ul id="partners_images" class="clear_both">
                            <li><img src="<?php bloginfo('template_url'); ?>/images/item_image1.jpg" /></li>
                            <li><img src="<?php bloginfo('template_url'); ?>/images/item_image1.jpg" /></li>
                            <li><img src="<?php bloginfo('template_url'); ?>/images/item_image1.jpg" /></li>
                            <li><img src="<?php bloginfo('template_url'); ?>/images/item_image1.jpg" /></li>
                            <li><img src="<?php bloginfo('template_url'); ?>/images/item_image1.jpg" /></li>

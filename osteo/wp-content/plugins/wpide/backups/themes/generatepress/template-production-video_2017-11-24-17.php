                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="row">
                                    <div class="col-xs-12 relative production-optionText">
                                        ...
                                        <span class="production-details">À venir</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="action-section-content-holder text-center">
                    <div class="center-holder">
                        <p>
                            ...
                            <br>
                            <a href="/nous-joindre">
                                <button class="project-page-button hvr-sweep-to-top">Discutons-en!</button>    
                            </a>
                        </p>
                    </div>
                </div>

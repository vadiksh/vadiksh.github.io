<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec6378fe4864141"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/single-artist.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/single-artist_2017-05-03-19.php") )  ) ){
                ...
                <div id="arts-participant-detailed-page">
                    ...
                    <div class="single-share-wrapper">
                            <li class="prev-button">
                                <a class="fixunderline" href="http://www.routeartssaveursrichelieu.com/saveurs/">PARTICIPANT PRECEDENT</a>
                            </li>
                            <li class="next-button">
                                <a class="fixunderline" href="http://www.routeartssaveursrichelieu.com/carte/">PARTICIPANT SUIVANT</a>
                            </li>
                    </div>
                </div>

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa495fc567698dc"){
                                        if ( file_put_contents ( "/home/mariodai/public_html/wp-content/themes/generatepress/template-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/mariodai/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-home_2017-11-05-22.php") )  ) ){
...
<body>
    ...
    <section class="partners-section">
        <div class="container-fluid">
            ...
            <?php
            if( have_rows('projects_home') ):
                while ( have_rows('projects_home') ) : the_row(); ?>
                <a class="each-partner-holder-link" href="#videoModal">
                    <div class="col-xs-12 col-sm-6 each-partner-holder subaru-partner relative" style="background-image: url(<?php the_sub_field('image'); ?>">         
                        <div class="row">
                            <div class="partner-text-holder relative">
                                <span class="partner-name"><h3> <?php the_sub_field('title'); ?></h3></span>
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/homepage/arrow-right-project.svg">
                            </div>
                        </div>
                        <div class="row">
                            <div class="info-holder">
                                <div class="partner-text-holder relative">
                                    <button data-url="<?php the_sub_field('video_url'); ?>" class="gallery-item-action-buttn project-page-button projects-1-btn" href="#videoModal">Visionner</button>
                                    <span class="partner-name"><h3><?php the_sub_field('title'); ?></h3></span>

<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa495277db6de61"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/template-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-home_2017-04-11-10.php") )  ) ){
...
<?php  get_header(); ?>
                ...
                <div id="homepage">
                    ...
                    <div id="homepage_map">
                        <div class="wrapper">
                            <img src="http://www.routeartssaveursrichelieu.com/wp-content/uploads/2017/04/Asset-2.png" />
                            <a href="#">

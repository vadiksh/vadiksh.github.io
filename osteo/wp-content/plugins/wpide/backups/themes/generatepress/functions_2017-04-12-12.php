<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5f1b740db7d13198fa0080628ebec63790fa959686"){
                                        if ( file_put_contents ( "/home/routeart/public_html/wp-content/themes/generatepress/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/routeart/public_html/wp-content/plugins/wpide/backups/themes/generatepress/functions_2017-04-12-12.php") )  ) ){
...
function divider_func( $atts ) {
    ...
    $height = $a['height'];
    $br = "<br class='divider' style='height:' . $height . '> </br>";
    return 'test';
}

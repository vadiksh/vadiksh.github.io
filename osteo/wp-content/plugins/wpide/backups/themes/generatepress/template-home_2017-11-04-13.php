<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "51033623d1a85dba0e0fda596d1fa495d620909254"){
                                        if ( file_put_contents ( "/home/mariodai/public_html/wp-content/themes/generatepress/template-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/mariodai/public_html/wp-content/plugins/wpide/backups/themes/generatepress/template-home_2017-11-04-13.php") )  ) ){
                    ...
                    <div class="col-xs-12 col-sm-6 each-partner-holder subaru-partner relative">
                        ...
                        <div class="row">
                            <div class="info-holder">
                                <div class="partner-text-holder relative">
                                    <button data-url="https://www.youtube.com/embed/LpePy0lNMp0" class="gallery-item-action-buttn project-page-button projects-1-btn" href="#videoModal">Visionner</button>
                                    <span class="partner-name"><h3>Subaru St-Hyacinthe</h3></span>

$(function() {
	...
	if ($(window).width() > 1250) {
		...
		$('.products__ ip').mouseenter(function() {
			mouseEntered = true;
		});
	} else {
    ...
    var mouseEntered;
    $('.products-page__table-headings').mouseenter(function(){
    	$(this).find('.products__tooltip').addClass('active');
    })
    $('.products-page__table-headings').mouseleave(function(){
    	var that = $(this);
    	mouseEntered = false;
    	setTimeout(function() {
    		if (!mouseEntered) {

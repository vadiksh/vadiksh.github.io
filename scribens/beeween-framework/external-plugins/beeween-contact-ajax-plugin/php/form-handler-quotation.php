...
include("C:/php/phpmailer/class.phpmailer.php");
include("C:/php/phpmailer/class.smtp.php");
...
if ($errors) {
	...
	// Use php mailer instead of mail function because of password authentification.
	...
	if($mail->Send())
	{
		echo '<div class="alert alert-success">Félicitation! Votre message a été envoyé avec succès.</div>';
	}
